...
public class ItoPostcardEncoder {
...
fileprivate protocol PostcardArrayMarker {
...
fileprivate class _PostcardEncoder: Encoder {
...
fileprivate struct _PostcardKeyedEncodingContainer<Key: CodingKey>: KeyedEncodingContainerProtocol {
...
fileprivate struct _PostcardUnkeyedEncodingContainer: UnkeyedEncodingContainer {
    var codingPath: [CodingKey] { encoder.codingPath }
    let encoder: _PostcardEncoder
    var count: Int = 0
...
fileprivate struct _PostcardSingleValueEncoder: SingleValueEncodingContainer {
    var codingPath: [CodingKey] { encoder.codingPath }
    let encoder: _PostcardEncoder
